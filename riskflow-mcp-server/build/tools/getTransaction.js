...
exports.registerGetTransaction = registerGetTransaction;
...
function registerGetTransaction(server) {
    server.tool(
    ...
    {
        transaction_id: zod_1.z.string().describe("The transaction ID to look up, e.g. txn_abc123"),
    }, 
